...
\Module{salaireNet}{}{}
    ...
    \Read salaire
    \If{salaire > 1200}
        \Let salaire \Gets salaire - (salaire * RETENUE) / 100
    \EndIf
    \Write salaire
...
\Module{dateValide}{}{}
    ...
    \Decl anneeBissextile : booléen
    \Read jour, mois, annee
    \If{annee MOD 4 = 0 ET NON(annee MOD 100 = 0)}
        \Let anneeBissextile \Gets vrai
    \Else
        \Let anneeBissextile \Gets annee MOD 400 = 0
    \EndIf
...
\Module{jourSemaine}{}{}
    ...
    \Read dateMois
    \Switch{dateMois MOD 8 \K{vaut}}
        \Stmt 1 : \K{afficher} "vendredi"
        \Stmt 2 : \K{afficher} "samedi"
        \Stmt 3 : \K{afficher} "dimanche"
        \Stmt 4 : \K{afficher} "lundi"
        \Stmt 5 : \K{afficher} "mardi"
        \Stmt 6 : \K{afficher} "mercredi"
        \Stmt 7 : \K{afficher} "jeudi"
    \EndSwitch
...
\Module{jourFutur}{}{}
    ...
    \Switch{(jourFutur + n) MOD 8 \K{vaut}}
        \Stmt 1 : \K{afficher} "vendredi"
        \Stmt 2 : \K{afficher} "samedi"
        \Stmt 3 : \K{afficher} "dimanche"
        \Stmt 4 : \K{afficher} "lundi"
...
\Module{bienStationné}{}{}
    ...
    \If{1 $\ge$ dateJour $\ge$ 15}
        \Write NON(dateJour MOD 2 = 0)
    \Else
        \Write dateJour MOD 2 = 0
    \EndIf
