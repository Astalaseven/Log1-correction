...
\include{log1-alternative-correction}
\include{log1-module-correction}
\include{log1-structure-correction}
\include{log1-boucle-correction}
\include{log1-tableau-correction}
